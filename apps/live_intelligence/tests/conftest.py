"""Live Intelligence test fixtures."""
...
@pytest.fixture
def live_config() -> LiveIntelligenceConfig:
    return LiveIntelligenceConfig()
...
def mock_llm() -> LLMGateway:
    ...
    mock_response.content = [MagicMock(text="Event readiness: OK. CDN pre-scale recommended at 2x.")]
