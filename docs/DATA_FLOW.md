...
EVENT_ROUTING = {
    ...
    EventType.INCIDENT_CREATED:        {"pub": "ops_center",          "subs": ["alert_center", "knowledge_base"]},  # ✅ S03+S04+S08 (KB auto-index)
    EventType.RCA_COMPLETED:           {"pub": "ops_center",          "subs": ["knowledge_base", "alert_center"]},  # ✅ S03+S04+S08 (KB auto-index)
